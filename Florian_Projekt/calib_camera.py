...
markerLength = 4.0  # Here, measurement unit is centimetre.
...
if calibrate_camera == True:
    ...
    while True:
        ...
        if corners == None:
            ...
            ret, rvec, tvec = aruco.estimatePoseBoard(corners, ids, board, newcameramtx, dist, rvec=0,tvec=0) # For a board
